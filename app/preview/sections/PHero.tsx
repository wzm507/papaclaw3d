...
export default function PHero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.p-hero-sub', { y: 40, opacity: 0 }, { y: 0, opacity: 1, duration: 1, stagger: 0.12, ease: 'expo.out', delay: 0.9 })
      gsap.fromTo('.p-hero-cta', { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.9, ease: 'expo.out', delay: 1.2 })
      gsap.fromTo('.p-hero-card', { y: 60, opacity: 0 }, { y: 0, opacity: 1, duration: 1, ease: 'expo.out', delay: 1.0 })
    }, heroRef)
      ...
      <div className="p-inner relative z-10 pb-24">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-8">
            <p className="p-hero-sub p-kicker mb-8">Papa Claw · 爬爬虾</p>

            <div className="overflow-hidden" style={{ perspective: '800px' }}>
              <h1 className="p-hero-line p-display mb-2 text-[#0F1C1A] will-change-transform" style={{ transformOrigin: 'center bottom' }}>
                我们不靠赚方案的钱活着。
              </h1>
            </div>
            <div className="overflow-hidden" style={{ perspective: '800px' }}>
              <h1 className="p-hero-line p-display mb-12 text-[#0F1C1A] will-change-transform" style={{ transformOrigin: 'center bottom' }}>
                我们靠你赚到钱活着。
              </h1>
            </div>

            <div className="max-w-2xl">
              <p className="p-hero-sub p-body-lg">先付出，先交朋友，用成本价帮你出海。</p>
              <p className="p-hero-sub p-body-lg mt-2">你不赚钱，我们只收工时费。</p>
            </div>

            <div className="p-hero-cta mt-12 flex flex-wrap gap-4">
          ...
          <div className="flex items-end lg:col-span-4">
            <div className="p-hero-card w-full border border-[#E5E5E0] bg-white p-6 md:p-8">
