...
const pillars = [
  {
    index: '01',
    title: '我们先付出，你先赚钱',
    us: '很多公司一上来就收咨询费、签年框、画 PPT。我们按结果付费，客户没赚到钱只收工时费。先把事做成，再谈合作。',
    contrast: { them: '方案交完就结束', us: '你赚不到，我们也不多拿' },
  },
  {
    index: '02',
    title: '我们是真在海外干过，不是查资料写的',
    us: '在迪拜待了 14 年，卖过 3 栋楼；在香港也真正跑通过卖货渠道，把工厂货卖出去。操盘过十几亿。中东、南沙、港澳三地怎么打交道，我们是真知道。',
    contrast: { them: '讲得多，落不了地', us: '自己干过，才敢接' },
  },
  {
    index: '03',
    title: '我们用AI获客，不是用人海战术',
    us: '别家代运营养一队人手动发帖、手动回复。我们用AI批量生产内容、自动分发多平台、做AI搜索占位(GEO)。同样预算，产出量是人工的10倍。',
    contrast: { them: '人海战术，成本高', us: 'AI引擎，效率高' },
  },
]
