  ...
  return (
    <section id="news" ref={sectionRef} className="editorial-section bg-paper-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div ref={cardsRef} className="space-y-3">
          {featured ? (
            <Link
              ...
              className="news-card neo-panel grid gap-8 rounded-content p-6 opacity-0 transition-transform hover:-translate-y-1 md:grid-cols-[1.1fr_1.9fr] md:p-9"
            >
              <div className="flex flex-col justify-between gap-8">
                <div>
                  <p className="editorial-meta mb-4">{formatDate(featured.publishedAt)}</p>
                  <p className="font-utility text-sm font-semibold uppercase text-foudre-pink">
              ...
              <div>
                <h3 className="font-utility text-3xl font-semibold leading-tight text-deep-forest md:text-heading-lg">
            ...
            <div className="news-card neo-panel rounded-content p-8 text-center opacity-0">
              <h3 className="font-utility text-heading font-semibold text-deep-forest">新闻中心等待首次同步</h3>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {rest.map((article) => (
                <Link
                  ...
                  className="news-card neo-panel rounded-content p-6 opacity-0 transition-transform hover:-translate-y-1 md:p-7"
                >
                  <p className="editorial-meta mb-4">{formatDate(article.publishedAt)}</p>
                  <h3 className="font-utility text-2xl font-semibold leading-snug text-deep-forest">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-5 border-b border-deep-forest/10 pb-8 md:flex-row">
