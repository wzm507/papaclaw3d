...
const CATEGORY_RULES: CategoryRule[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      { word: '采购', weight: 7 },
      { word: '竞标', weight: 11 },
      { word: 'tender', weight: 12 },
      { word: 'bid', weight: 10 },
      { word: 'procurement', weight: 11 },
      { word: 'rfp', weight: 11 },
    ],
  },
  {
    ...
    keywords: [
      ...
      { word: '社交媒体', weight: 12 },
      { word: '海外社媒', weight: 14 },
      { word: 'TikTok', weight: 10 },
      { word: 'LinkedIn', weight: 10 },
      { word: 'Instagram', weight: 10 },
      { word: 'Facebook', weight: 10 },
      { word: 'Twitter', weight: 9 },
      { word: 'YouTube', weight: 9 },
      { word: '内容营销', weight: 12 },
      { word: '网红', weight: 11 },
      { word: 'KOL', weight: 11 },
      { word: '达人', weight: 10 },
  ...
  },
  {
    ...
    keywords: [
      ...
      { word: 'SHEIN', weight: 9 },
      { word: 'Temu', weight: 9 },
      { word: 'Shopee', weight: 9 },
      { word: 'Lazada', weight: 9 },
      { word: '外贸企业', weight: 12 },
      { word: '生产商', weight: 11 },
      { word: '厂家', weight: 10 },
      { word: '产品出海', weight: 12 },
  ...
  },
  {
    ...
    keywords: [
      ...
      { word: '自动驾驶', weight: 10 },
      { word: '智能硬件', weight: 9 },
      { word: 'OpenAI', weight: 10 },
      { word: 'DeepSeek', weight: 10 },
      { word: 'Anthropic', weight: 10 },
      { word: 'Claude', weight: 9 },
      { word: 'ChatGPT', weight: 9 },
      { word: '独角兽', weight: 7 },
      { word: '科技企业', weight: 8 },
      { word: '互联网', weight: 6 },
      { word: '软件', weight: 6 },
...
export function classifyNews(title: string, summary: string): { slug: string; title: string; score: number } {
  const text = `${title}\n${summary}`
  ...
  const scores = CATEGORY_RULES.map((rule) => {
    ...
    for (const { word, weight } of rule.keywords) {
      ...
      const count = (normalizedText.match(new RegExp(wordLower.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), 'g')) || []).length
      if (count > 0) {
    ...
    if (rule.antiKeywords) {
      for (const anti of rule.antiKeywords) {
        ...
        if (normalizedText.includes(antiLower)) {
          score -= 15
        }
      }
    }
...
export function findBestTopicByContent(title: string, summary: string, topics: SeoTopic[]): SeoTopic | null {
  const result = classifyNews(title, summary)
  return topics.find((topic) => topic.slug === result.slug) || null
}
