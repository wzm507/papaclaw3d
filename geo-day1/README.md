...
1. 完成 `01-ai-baseline-test.csv`：15 个问题 x 4 个平台，逐题截图。
2. 按 `03-baidu-baike-draft.md` 提交百度百科词条。
3. 按 `04-zhihu-article-day1.md` 发布知乎首篇文章。
4. 按 `05-evidence-checklist.md` 留存截图和链接。
5. 用 `06-day1-report-template.md` 记录当天结果。
...
- 登录 DeepSeek、豆包、Kimi、通义千问，按表格完成 15 题基线测试。
- 登录百度百科后台，提交词条。
- 按 `baike-platforms/` 里的多平台草稿，依次提交百度百科、360百科、搜狗百科、头条/快懂百科。
- 搜狗百科如果找不到“分类”，看 `baike-platforms/06-sogou-category-guide.md`，优先填写“开放分类/词条标签”。
- 登录知乎，发布文章。
- 截图并把链接/截图文件名填回表格。
